...
class TestSessionPerformance:
    ...
    def test_session_update_performance(self):
        ...
        session = {"session_id": "test_session", "status": "active", "data": {}}
    ...
    def test_session_cleanup_performance(self):
        ...
        sessions = [
            {"session_id": f"s_{i}", "created_at": time.time() - (i * 100)} for i in range(1000)
        ]
        ...
        # Remove old sessions
        active_sessions = [s for s in sessions if s["created_at"] > cutoff_time]
    ...
    def test_session_state_transitions(self):
        ...
        transitions = ["processing", "paused", "processing", "completed"]
    ...
    def test_session_query_filtering(self):
        ...
        filtered = [s for s in sessions if s["status"] == "active" and s["created_at"] > cutoff]
