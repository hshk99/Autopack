...
def main():
    ...
    parser.add_argument("--run-id", required=False, help="Run id (e.g., fileorg-country-uk-20251205-132826)")
    parser.add_argument("--family", help="Family prefix; if omitted, derived from run-id prefix before timestamp")
    ...
    parser.add_argument("--doc-name", help="Optional doc name to route (e.g., IMPLEMENTATION_PLAN.md)")
    parser.add_argument("--doc-purpose", help="Optional doc purpose (plan/analysis/prompt/log/script/report)")
    ...
    if args.doc_name:
        doc_dest = route_new_doc(args.doc_name, purpose=args.doc_purpose, project_hint=args.project_hint, archived=args.archived)
