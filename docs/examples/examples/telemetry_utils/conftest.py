...
def delimiter_strings() -> List[str]:
    ...
    """
    return ["hello-world", "python_programming", "test|case|example", "one,two,three", "a:b:c:d"]
...
def palindrome_strings() -> List[str]:
    ...
    """
    return ["racecar", "level", "noon", "radar", "civic", "madam", "refer"]
...
def numeric_strings() -> List[str]:
    ...
    """
    return ["test123", "abc123def", "12345", "version 2.0", "python3"]
...
def mixed_case_strings() -> List[str]:
    ...
    """
    return ["HeLLo WoRLd", "PyThOn", "TeSt CaSe", "MiXeD", "CamelCase"]
...
def unicode_strings() -> List[str]:
    ...
    """
    return ["café", "naïve", "résumé", "hello🌍", "test™", "©2024"]
