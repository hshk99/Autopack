...
def write_file(path: Union[str, Path], content: str, encoding: str = 'utf-8',
               create_dirs: bool = False, append: bool = False) -> None:
...
def read_lines(path: Union[str, Path], encoding: str = 'utf-8',
               strip_newlines: bool = True, skip_empty: bool = False) -> List[str]:
...
def write_lines(path: Union[str, Path], lines: List[str], encoding: str = 'utf-8',
                add_newlines: bool = True, create_dirs: bool = False,
