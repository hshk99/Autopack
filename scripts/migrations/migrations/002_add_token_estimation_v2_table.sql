-- Migration: Add token_estimation_v2_events table
-- Created: 2025-12-24
-- Purpose: Track TokenEstimationV2 telemetry with deliverables for validation

-- ============================================================================
-- Table: token_estimation_v2_events
-- Purpose: Track BUILD-129 overhead model predictions vs actuals with deliverables
-- ============================================================================
...
-- ============================================================================
-- View: Token estimation validation metrics
-- ============================================================================
...
SELECT
    ...
    ROUND(AVG(CASE WHEN success = 1 THEN waste_ratio END), 2) as median_waste_ratio_success,
...
-- ============================================================================
-- View: Recent token estimation events
-- ============================================================================
