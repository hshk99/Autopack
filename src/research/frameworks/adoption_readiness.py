...
class AdoptionReadiness:
    ...
    def add_barrier(self, name: str, impact: str, timeframe: str, mitigation: str) -> None:
    ...
    def get_adoption_timeline(self) -> str:
        ...
        long_term_barriers = sum(1 for b in self.barriers if b["timeframe"] == "long")
        medium_term_barriers = sum(1 for b in self.barriers if b["timeframe"] == "medium")
    ...
    def _get_critical_barriers(self) -> List[Dict[str, Any]]:
        ...
        return [barrier for barrier in self.barriers if barrier["impact"] in ["high", "critical"]]
