...
class GitHubGatherer:
    ...
    def gather_issues(self, owner: str, repo: str, state: str = "open", max_issues: int = 100) -> List[Dict[str, Any]]:
    ...
    def gather_pull_requests(self, owner: str, repo: str, state: str = "open", max_prs: int = 100) -> List[Dict[str, Any]]:
