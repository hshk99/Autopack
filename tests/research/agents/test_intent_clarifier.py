...
class TestIntentClarifier:
    ...
    def test_determine_scope(self):
        ...
        quick = self.clarifier._determine_scope("Quick overview of REST APIs")
        assert quick == "quick"

    def test_determine_priority(self):
        """Test priority determination."""
        high = self.clarifier._determine_priority("Urgent: need to fix production bug")
        assert high == "high"

        low = self.clarifier._determine_priority("Nice to have: optional feature")
        assert low == "low"
    ...
    def test_refine_intent(self):
        ...
        feedback = {"add_topics": ["FastAPI", "REST"], "scope": "comprehensive", "priority": "high"}
