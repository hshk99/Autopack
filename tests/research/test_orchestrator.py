...
class TestResearchOrchestrator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.intent_description = "A study to understand the effects of climate change on marine ecosystems."
        self.intent_objectives = ["Analyze temperature changes", "Assess species migration patterns"]
