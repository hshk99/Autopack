"""Retry research-api-router with clean main.py (v4)"""
...
# Create tier
tier = Tier(
    tier_id="api-router-retry-v4-tier",
    run_id="retry-api-router-v4",
    tier_index=0,
    name="API Router Retry v4",
    description="Retry research-api-router with clean main.py (removed conflict markers)",
...
db.commit()
print(f"Created retry-api-router-v4 run with {phase.phase_id} phase")
db.close()
