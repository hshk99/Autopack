...
class TestCalibrationReport:
    ...
    def test_calculate_overall_confidence_weighted(self):
        ...
        report.add_change(CoefficientChange(
            key="key1",
            old_value=1000.0,
            new_value=1100.0,
            change_pct=10.0,
...
class TestCalibrationReporter:
    ...
    def test_calculate_confidence_high_samples(self, reporter):
        ...
        confidence = reporter._calculate_confidence(
            sample_count=25,
    ...
    def test_calculate_confidence_large_change(self, reporter):
        ...
        small_change = reporter._calculate_confidence(
            sample_count=15,
            change_magnitude=10.0
        )
        large_change = reporter._calculate_confidence(
            sample_count=15,
