...
def write_ini(path: Union[str, Path], config: configparser.ConfigParser,
...
def get_value(path: Union[str, Path], section: str, key: str,
              default: Optional[Any] = None, encoding: str = 'utf-8') -> Optional[str]:
...
def set_value(path: Union[str, Path], section: str, key: str, value: Any,
              encoding: str = 'utf-8', create_dirs: bool = False) -> None:
