...
class TestProductFeasibility:
    ...
    def test_add_risk_factor(self):
        ...
        framework.add_risk_factor(
            name="Technical complexity", severity="high", mitigation="Hire specialized expertise"
        )
    ...
    def test_add_risk_factor_invalid_severity(self):
        ...
        with pytest.raises(ValueError, match="Severity must be one of"):
            framework.add_risk_factor(name="Test risk", severity="invalid", mitigation="Test")
    ...
    def test_get_risk_adjusted_score(self):
        ...
        framework.add_risk_factor(
            name="High complexity", severity="high", mitigation="Phased approach"
        )
    ...
    def test_get_detailed_analysis(self):
        ...
        framework.add_risk_factor(name="Test risk", severity="medium", mitigation="Test mitigation")
