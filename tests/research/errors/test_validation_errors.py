...
class TestValidationErrors:
    ...
    def test_parameter_type_validation(self):
        ...
        valid_params = {"depth": 3, "timeout": 30, "max_results": 100}
    ...
    def test_result_format_validation(self):
        ...
        valid_result = {"finding": "Test finding", "confidence": 0.85, "source": "source1"}
    ...
    def test_metadata_validation(self):
        ...
        invalid_metadata = {"created_at": "invalid-date", "updated_at": None, "version": ""}
