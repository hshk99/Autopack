...
def run_evaluation() -> dict[str, Any]:
    ...
    if test_file:
        ...
        try:
            ...
            results["metrics"]["test_stdout"] = proc.stdout[-2000:] if len(proc.stdout) > 2000 else proc.stdout
            results["metrics"]["test_stderr"] = proc.stderr[-1000:] if len(proc.stderr) > 1000 else proc.stderr
    ...
    if normalization_file:
        ...
        results["metrics"]["has_citation_class"] = "class Citation" in content or "class Normalizer" in content
