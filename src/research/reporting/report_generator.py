...
class ReportGenerator:
    ...
    def __init__(self, synthesis: Dict[str, Any], 
...
"""
    ...
    def _generate_framework_analyses(self) -> str:
        ...
        if 'market_attractiveness' in framework_analyses:
            section += self._format_market_analysis(
                framework_analyses['market_attractiveness']
            )
        
        # Product Feasibility
        if 'product_feasibility' in framework_analyses:
            section += self._format_feasibility_analysis(
                framework_analyses['product_feasibility']
            )
        ...
        if 'adoption_readiness' in framework_analyses:
            section += self._format_adoption_analysis(
                framework_analyses['adoption_readiness']
            )
