"""Phase handler for diagnostics-cursor-prompt batched execution.

Specialized in-phase batching for followup-2 `diagnostics-cursor-prompt` (code -> dashboard -> tests -> docs).
"""
...
def execute(
    ...
    *,
    ...
    """Execute diagnostics-cursor-prompt phase with batched deliverables.
