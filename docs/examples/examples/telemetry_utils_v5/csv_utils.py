...
def read_csv(
    path: Union[str, Path], encoding: str = "utf-8", delimiter: str = ",", skip_header: bool = False
) -> List[List[str]]:
...
def from_dicts(
    dicts: List[Dict[str, Any]], headers: Optional[List[str]] = None, include_header: bool = True
) -> List[List[str]]:
