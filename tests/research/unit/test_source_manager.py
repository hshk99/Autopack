...
class TestSourceManager:
    ...
    def test_source_rate_limiting(self):
        ...
        source = {"id": "s1", "rate_limit": {"requests_per_minute": 60, "requests_per_hour": 1000}}
    ...
    def test_source_authentication(self):
        ...
        source = {
            "id": "s1",
            "auth": {"type": "api_key", "key_name": "X-API-Key", "key_value": "secret_key_123"},
        }
    ...
    def test_source_timeout_configuration(self):
        ...
        source = {"id": "s1", "timeout": {"connect": 5, "read": 30, "total": 60}}
