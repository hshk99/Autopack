...
def demo_dict_utils() -> None:
    ...
    print(f"Get 'user.profile.email' (default): {get_nested(nested_dict, 'user.profile.email', default='N/A')}")
...
Examples:
  ...
  %(prog)s --string --number  Run multiple specific demos
    ...
    parser.add_argument(
        '--string',
        action='store_true',
        help='Demonstrate string utility functions'
    )
    parser.add_argument(
        '--number',
        action='store_true',
        help='Demonstrate number utility functions'
    )
    parser.add_argument(
        '--list',
        action='store_true',
        help='Demonstrate list utility functions'
    )
    parser.add_argument(
        '--dict',
        action='store_true',
        help='Demonstrate dictionary utility functions'
    )
    parser.add_argument(
        '--validation',
        action='store_true',
        help='Demonstrate validation utility functions'
    )
    parser.add_argument(
        '--version',
        action='version',
