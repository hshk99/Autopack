    ...
    def test_scan_drive_filters_by_max_depth(self, mock_run):
        ...
        with patch('pathlib.Path', return_value=mock_csv_path):
            with patch('builtins.open', MagicMock()):
                with patch('csv.DictReader') as mock_csv_reader:
                    mock_csv_reader.return_value = [
                        {'File Name': 'C:\\', 'Size': '1000', 'Modified': '2025-12-01 10:00:00', 'Attributes': 'd'},
                        {'File Name': 'C:\\temp', 'Size': '500', 'Modified': '2025-12-01 09:00:00', 'Attributes': 'd'},
                        {'File Name': 'C:\\temp\\sub', 'Size': '200', 'Modified': '2025-12-01 08:00:00', 'Attributes': 'd'},
                        {'File Name': 'C:\\temp\\sub\\file.txt', 'Size': '100', 'Modified': '2025-12-01 07:00:00', 'Attributes': '-'},
                    ]
                    ...
                    assert len(results) == 2
                    assert all('\\' not in r.path.replace('C:\\', '') or r.path.count('\\') <= 2 for r in results)
