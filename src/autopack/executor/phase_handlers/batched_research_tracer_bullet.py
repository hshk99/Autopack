"""Phase handler for research-tracer-bullet batched execution.
...
def execute(
    ...
    *,
    ...
    """Execute research-tracer-bullet phase with batched deliverables.
    ...
    for idx, batch_paths in enumerate(batches, 1):
        ...
        builder_result = executor.llm_service.execute_builder_phase(
            ...
            run_token_budget=getattr(executor, "run_budget_tokens", None),
            tokens_used_so_far=getattr(executor, "_run_tokens_used", None),
        )
