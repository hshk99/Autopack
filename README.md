...
- End-to-end helper: `scripts/run_backlog_maintenance.py --backlog consolidated_debug.md --allowed-path src/` parses backlog → plan → diagnostics (propose-first, no apply) in one step.
