"""Phase handler for diagnostics-handoff-bundle batched execution.

Specialized in-phase batching for followup-1 `diagnostics-handoff-bundle` (code -> cli -> tests -> docs).
"""
...
def execute(
    ...
    *,
    ...
    """Execute diagnostics-handoff-bundle phase with batched deliverables.
