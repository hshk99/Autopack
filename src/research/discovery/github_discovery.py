...
class GitHubDiscovery:
    ...
    def search_repositories(self, query: str, language: Optional[str] = None,
                          min_stars: int = 0, max_results: int = 30) -> List[GitHubRepository]:
    ...
    def search_issues(self, query: str, repository: Optional[str] = None,
                     state: str = "open", max_results: int = 30) -> List[GitHubIssue]:
    ...
    def get_trending_repositories(self, language: Optional[str] = None,
                                 since: str = "daily") -> List[GitHubRepository]:
