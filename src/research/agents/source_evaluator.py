...
class SourceEvaluator:
    ...
    def evaluate(self, source_url: str, content: Optional[str] = None,
                metadata: Optional[Dict] = None, query_keywords: Optional[List[str]] = None) -> SourceEvaluation:
        ...
        if content and query_keywords:
            relevance_score, relevance_reasoning = self._evaluate_relevance(
