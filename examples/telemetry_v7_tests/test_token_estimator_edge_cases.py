...
class TestTokenEstimatorEdgeCases:
    ...
    def test_zero_deliverables(self, estimator):
        ...
        result_simple = estimator.estimate(
            deliverable_count=0,
            category="simple",
            complexity="low"
        )
    ...
    @pytest.mark.parametrize("deliverable_count,expected_capped", [
    ...
    def test_huge_deliverable_counts(self, estimator, deliverable_count, expected_capped):
        ...
        uncapped = int(
            (5000 + deliverable_count * 2000) * 1.5 * 1.3
        )
        assert uncapped > TokenEstimator.MAX_BUDGET
    
    @pytest.mark.parametrize("category,complexity,expected_multiplier", [
    ...
    def test_missing_category_complexity(self, estimator, category, complexity, expected_multiplier):
    ...
    @pytest.mark.parametrize("deliverable_count,category,complexity,expected", [
    ...
    def test_boundary_cases_near_cap(self, estimator, deliverable_count, category, complexity, expected):
